...
The 86 immune loci were saved to the file **MHC-loci.fas** ... and 84 of these were submitted to Arbor Biosciences for bait design (WeinellEntry1815-1898). Ultastringent filtration (conducted by Arbor) removed 29 immune loci (0% bait coverage). Additionally, 16 immune loci were filtered because the baits were non-specific within the genome of *T. sirtalis* and/or *Thermophis baileyi*; 12 immune loci were "removed" from the target set because they were already targeted as REEs (**Version1_removed-loci_duplicate-targets.tsv**). The final set of target loci (for which baits were synthesised) included 27 immune loci (plus 8 REEs that are also immune loci).
