...
Vision loci: I used blastn to search for the vision loci probes from Schott et al. (2017) (which were from *Anolis*, *Columba*, or *Gallus*) within the snake genomes. Vision loci that were present in all snake genomes were retained, and I designed new probes for these shared vision loci based on *T. sirtalis*.
