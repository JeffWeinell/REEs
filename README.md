...
The output sequences were saved in fasta format and can be downloaded here: [Anolis.carolinensis.tblastx.best.hits_seqs.fas](https://osf.io/efu2n/download), [Gekko.japonicus.tblastx.best.hits_seqs.fas](https://osf.io/rpzvh/download), [Pogona.vitticeps.tblastx.best.hits_seqs.fas](https://osf.io/hg9pq/download), [Crotalus.horridus.tblastx.best.hits_seqs.fas](https://osf.io/9qbrx/download), [Crotalus.mitchellii.tblastx.best.hits_seqs.fas](https://osf.io/q9ytz/download), [Ophiophagus.hannah.tblastx.best.hits_seqs.fas](https://osf.io/ckxm9/download), [Pantherophis.guttatus.tblastx.best.hits_seqs.fas](https://osf.io/9wd4a/download), [Protobothrops.mucrosquamatus.tblastx.best.hits_seqs.fas](https://osf.io/hpdw9/download), [Python.bivittatus.tblastx.best.hits_seqs.fas](https://osf.io/b3d6w/download), [Vipera.berus.tblastx.best.hits_seqs.fas](https://osf.io/5tnr4/download), [Thamnophis.sirtalis.tblastx.best.hits_seqs.fas](https://osf.io/psvg8/download). **Upload updated versions to Open Science Framework, which have sequence header names without the genus and species names included after "Subject="**
...
UCEs.best.hits.Vipera.berus                 <- REEs::reportBestMatches(input.table=Vipera.berus.blastn.UCEs.50hits, output.table.path="Vipera.berus.blastn.UCEs.best.hits.txt")
```
...
writeXStringSet(Vipera.berus.best.hits.seqs,"Thamnophis.sirtalis.UCEs_renamed.fas")
