...
Pagona.vitticeps.50hits             <- REEs::blast(method="tblastx",subject=Pagona.vitticeps.genome_url,query=Thamnophis.sirtalis_exome,table.out="./Pagona.vitticeps.tblastx.exons.50hits.txt")
...
The output TBLASTX hit tables containing the set of up to 50 matches per query can be downloaded here: [Anolis.carolinensis.tblastx.exons.50hits.txt](https://osf.io/8x2yb/download), [Gekko.japonicus.tblastx.exons.50hits.txt](https://osf.io/wus6k/download), [Pagona.vitticeps.tblastx.exons.50hits.txt](https://osf.io/hv4rq/download), [Crotalus.horridus.tblastx.exons.50hits.txt](https://osf.io/gr5wk/download), [Crotalus.mitchellii.tblastx.exons.50hits.txt](https://osf.io/x8wfa/download), [Ophiophagus.hannah.tblastx.exons.50hits.txt](https://osf.io/7vup9/download), [Pantherophis.guttatus.tblastx.exons.50hits.txt](https://osf.io/dv3am/download), [Protobothrops.mucrosquamatus.tblastx.exons.50hits.txt](https://osf.io/rgkfe/download), [Python.bivittatus.tblastx.exons.50hits.txt](https://osf.io/n4jzq/download), [Viperus.berus.tblastx.exons.50hits.txt](https://osf.io/e2m74/download), [Thamnophis.sirtalis.tblastx.exons.50hits.txt](https://osf.io/sf6wt/download).
...
best.hits.Pagona.vitticeps              <- REEs::reportBestMatches(input.table=Pagona.vitticeps.50hits,output.table.path="./Pagona.vitticeps.best.hits.txt")
...
```
The output table includes summary statistics and information for 66,489 alignments, and this table awas saved to the file [statsTable_REEs_SnakeCap.txt.gz](https://github.com/JeffWeinell/SnakeCap/raw/main/statsTable_REEs_SnakeCap.txt.gz).
