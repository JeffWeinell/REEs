...
#' @param primary.species The species whose contigs are in the first column of the input table indicated by the statsTable argument. For each locus, the other species were aligned to this species when the function makeStatsTable was run.
